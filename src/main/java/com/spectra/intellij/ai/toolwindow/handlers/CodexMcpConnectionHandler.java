...
public class CodexMcpConnectionHandler {
    ...
    public void setupCodexMcp(String jiraUrl, String username, String apiToken) {
        ...
        try {
            ...
            java.io.File codexDir = new java.io.File(basePath, ".codex");
            if (!codexDir.exists()) {
                codexDir.mkdirs();
            }

            // Create or update settings.json
            java.io.File settingsFile = new java.io.File(codexDir, "settings.json");
            ...
            Messages.showInfoMessage(
                project,
                "Codex MCP 설정이 .codex/settings.json에 추가되었습니다.\n\n" +
                "파일 경로: " + settingsFile.getAbsolutePath() + "\n\n" +
                "Codex를 재시작하면 Jira MCP가 연결됩니다.",
                "Codex MCP 연결 완료"
            );
